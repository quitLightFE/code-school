  ...
  return (
    <div className="relative min-h-[80vh] w-full flex flex-col items-center justify-center overflow-hidden px-4 py-12">
      ...
      <div className="relative z-10 flex flex-col items-center text-center max-w-lg mx-auto">
        ...
        <Code color="danger" radius="sm" className="px-3 py-1 font-mono text-sm mb-4">
        ...
        <div className="w-full text-left font-mono text-xs bg-content2 border border-content3 p-4 rounded-xl mb-8 text-default-600 shadow-inner">
          ...
          <p><span className="text-purple-500">const</span> <span className="text-blue-500">page</span> = <span className="text-amber-600">URL.getCurrent()</span>;</p>
          <p><span className="text-purple-500">if</span> (!page) <span className="text-purple-500">throw new</span> <span className="text-danger">CompassException</span>();</p>
        </div>
